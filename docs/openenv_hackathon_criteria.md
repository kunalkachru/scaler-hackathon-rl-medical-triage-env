...
| **Infra Restrictions** | Runtime of inference script should be less than 20 min. Make sure your env and inference can run on a machine with `vcpu=2`, `memory=8gb`. |
